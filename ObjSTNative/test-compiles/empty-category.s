...
@llvm.used = appending global [3 x i8*] [i8* getelementptr inbounds ([6 x i8]* @"\01L_OBJC_CLASS_NAME_", i32 0, i32 0), i8* bitcast (%struct._category_t* @"\01l_OBJC_$_CATEGORY_NSObject_$_empty" to i8*), i8* bitcast ([1 x i8*]* @"\01L_OBJC_LABEL_CATEGORY_$" to i8*)], section "llvm.metadata"
